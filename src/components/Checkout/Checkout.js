            ...
            <div className="woocommerce">
              ...
              <form id="login-form-wrap" className="login collapse" method="post">
                ...
                <p className="form-row">
                  <input type="submit" defaultValue="Login" name="login" className="button" />
                  <label className="inline" htmlFor="rememberme"><input type="checkbox" defaultValue="forever" id="rememberme" name="rememberme" /> Remember me </label>
                </p>
              ...
              <form id="coupon-collapse-wrap" method="post" className="checkout_coupon collapse">
                <p className="form-row form-row-first">
                  <input type="text" defaultValue id="coupon_code" placeholder="Coupon code" className="input-text" name="coupon_code" />
                </p>
                <p className="form-row form-row-last">
                  ...
                  <div className="col-1">
                    <div className="woocommerce-billing-fields">
                      ...
                      <p id="billing_country_field" className="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                        <label className htmlFor="billing_country">Country <abbr title="required" className="required">*</abbr>
                        </label>
                      ...
                      <div className="create-account">
                        ...
                        <p id="account_password_field" className="form-row validate-required">
                          ...
                          <input type="password" defaultValue placeholder="Password" id="account_password" name="account_password" className="input-text" />
                        </p>
                        <div className="clear" />
                      </div>
                    </div>
                  ...
                  <table className="shop_table">
                    ...
                    <tfoot>
                      ...
                      <tr className="shipping">
                        ...
                        <td>
                          Free Shipping
                          <input type="hidden" className="shipping_method" defaultValue="free_shipping" id="shipping_method_0" data-index={0} name="shipping_method[0]" />
                        </td>
                      </tr>
